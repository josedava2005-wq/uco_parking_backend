...
public interface PaisDAO
		extends CrearDAO<PaisEntidad>, ConsultarTodosDAO<PaisEntidad>, ConsultarPorIdDAO<PaisEntidad, UUID>,
		ConsultarPorFiltroDAO<PaisEntidad>, ActualizarDAO<PaisEntidad, UUID>, EliminarDAO<UUID> {
